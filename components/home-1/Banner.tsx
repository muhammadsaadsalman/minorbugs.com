...
import planet from "@/public/images/home/planet.webp";
import Image from "next/image";
import console1Image from "@/public/images/home/console.webp";
import console2Image from "@/public/images/home/game-control .webp";
...
import appStoreImage from "@/public/images/home/app-store.webp";
import googlePlayImage from "@/public/images/home/goog-store.webp";
import Slider from "react-slick";
import { TypeAnimation } from "react-type-animation";
import PrimaryBtn from "../PrimaryBtn";
import { Next, Prev } from "../SliderBtns";
import {featuredGames} from "@/public/data/home.data";
  ...
  return (
    <section className="banner-section index-one overflow-hidden">
      ...
      <div className="ellipse-area ellipse-three position-absolute">
        <Image src={ellipse3Image} className="ellipse-1" alt="icon" />
      </div>
              ...
              <div className="col-xl-4 col-lg-5 col-md-7 col-sm-9 mt-10 mt-lg-0 col-10">
                <Slider {...settings} className="game-carousel pb-20">
                  {featuredGames.map((game) => (
                      <div key={game.id} className="slide-area">
                        ...
                        <div className="single-slider p-3 p-sm-5">
                          <div className="thumb-wrapper">
                            <div className="thumb">
                              <Image width={392} height={491}  src={game.image} alt={game.title} />
                            </div>
